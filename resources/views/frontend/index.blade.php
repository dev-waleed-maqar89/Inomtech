                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>Web development involves creating and maintaining websites or web applications. It encompasses front-end (client-side) and back-end (server-side) development, ensuring functionality, responsiveness, and user experience.</p>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>AMobile application development involves creating software applications for smartphones and tablets. It includes designing, coding, testing, and deploying apps to provide functionality, entertainment, or information to users on-the-go.</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>
                                        Digital marketing services involve leveraging online channels to promote products or services. This includes strategies such as SEO, social media marketing, email campaigns, and content creation for effective online visibility.</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>Business development focuses on creating and implementing growth opportunities through strategic partnerships, market expansion, and customer acquisition, ultimately enhancing a company's revenue and market presence.</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>IT consultancy provides expert advice in managing technology to meet business goals. Consultants analyze systems, recommend improvements, and implement solutions, covering areas like cybersecurity, software development, and network infrastructure for optimized business efficiency and growth.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>E-commerce, short for electronic commerce, refers to the buying and selling of goods or services over the internet. It involves online transactions, electronic payments, and digital platforms where businesses and consumers can engage in buying and selling activities, often facilitated through websites and mobile applications.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>SEO (Search Engine Optimization) services focus on optimizing websites to improve their visibility on search engines. This involves keyword research, on-page and off-page optimization, content creation, and other strategies to enhance organic search rankings and drive targeted traffic to the website.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>Web development service is the process of building and developing websites and web applications that work over the Internet. Our web development service aims to create websites and web applications with excellent functionality, performance, and effective user experience</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>Mobile app servicing is the process of designing and developing applications that run on mobile devices such as smartphones and tablets. The mobile application service aims to provide a comfortable, smooth and integrated user experience for users on mobile devices</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>E-marketing service is the use of digital media and electronic platforms to promote and market products and services. This service aims to increase awareness and spread of a specific brand, and increase sales and potential customers..</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>Business development involves creating growth opportunities for a company. It includes identifying strategic partnerships, expanding market presence, acquiring new customers, and developing innovative products or services. The goal is to enhance revenue, market share, and overall business performance.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>
                                            Designer services encompass a range of creative professions, including graphic design, web design, and user experience (UX) design. Designers use their artistic and technical skills to create visually appealing and functional solutions, such as logos, websites, and user interfaces, tailored to meet clients' needs.
                                ...
                                <div class="widget-info">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <span><a href="https://wa.me/+201556783315">+20 155 678 3315</a></span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info-icon">
                                        ...
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <span>El Ekbal street , Louran , Alexandria, Egypt</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
