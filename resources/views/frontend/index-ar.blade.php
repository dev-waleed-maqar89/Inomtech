...
<!-- Mirrored from thepixelcurve.com/html/techwix/techwix/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 15:06:43 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>InomTechs - Information Technology Company</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo9.png">
...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-logo">
                        <a href="#"><img src="assets/images/logom.jpg" alt=""></a>
        ...
        <!-- Hero Start -->
        <div class="section techwix-hero-section-03 d-flex align-items-lg-center" style="background-image: url(assets/images/bg8.png);">
            <div class="shape-1">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="hero-content">
                            <h3 class="sub-title" data-aos-delay="600" data-aos="fade-up">استشارات تكنولوجيا ذات صلة</h3>
                            <h2 class="title" data-aos="fade-up" data-aos-delay="800">نحن نحول الأفكار إلى تكنولوجيا</h2>
                            <p data-aos="fade-up" data-aos-delay="900">نقدم أكثر تصاميم تكنولوجيا استجابةً ووظيفية للشركات والأعمال في جميع أنحاء العالم.</p>
                        ...
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>خدمة تطوير الويب هي عملية بناء وتطوير مواقع الويب وتطبيقات الويب التي تعمل عبر الإنترنت. تهدف خدمة تطوير الويب إلى إنشاء مواقع وتطبيقات ويب ذات وظائف وأداء ممتازين وتجربة مستخدم فعالة</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>خدمة تطبيقات الجوال هي عملية تصميم وتطوير التطبيقات التي تعمل على أجهزة الهواتف المحمولة مثل الهواتف الذكية والأجهزة اللوحية. تهدف خدمة تطبيقات الجوال إلى توفير تجربة استخدام مريحة وسلسة ومتكاملة للمستخدمين على الأجهزة المحمولة</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>
                                        خدمة التسويق الإلكتروني وهي عبارة عن استخدام الوسائط الرقمية والمنصات الإلكترونية للترويج والتسويق للمنتجات والخدمات. تهدف هذه الخدمة إلى زيادة الوعي والانتشار لعلامة تجارية معينة، وزيادة المبيعات والعملاء المحتملين .</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                        <div class="col-xl-3 col-md-6">
                            ...
                            <div class="service-item-03">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>خدمة تطوير الأعمال وهي تعنى تحسين وتوسيع نطاق العمل والنمو الاستراتيجي للشركات. تهدف هذه الخدمة إلى تحقيق النجاح والاستدامة عن طريق تطوير استراتيجيات جديدة وإيجاد فرص جديدة لتحقيق النمو والتوسع .</p>
                                </div>
                            </div>
                            <!-- Service Item End -->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-content-wrap">
                                ...
                                <p class="text">
                                    نحن شركة متخصصة منذ عام 2020 في تصميم المواقع والتطبيقات وتصاميم الهوية التجارية حيث لدينا فريق يتكون من مهندسي ومصممين برمجيات محترفين مع خبرة كبيرة وتقديم خدمات متفوقة ومتقنة في تنفيذها .
                                    </p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="more-choose-content text-center">
                                    <p>Learn more about <a href="service.html">More reason <i class="fas fa-long-arrow-alt-right"></i></a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    <div class="choose-us-img">
                                        <img src="assets/images/360-development.jpg" alt="" style="width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <div class="choose-us-content">
                                        <h3 class="title"><a href="#">IT Consultancy</a></h3>
                                        <p>تقدم استشارات تكنولوجيا المعلومات نصائح خبراء في إدارة التكنولوجيا لتحقيق أهداف الأعمال. يقوم الاستشاريون بتحليل الأنظمة وتوصية بتحسينها وتنفيذ الحلول، مغطين مجالات مثل أمان المعلومات، تطوير البرمجيات، وبنية الشبكة لتحقيق كفاءة الأعمال المحسّنة والنمو.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>التجارة الإلكترونية، والتي تعني التجارة الإلكترونية، تشير إلى شراء وبيع السلع أو الخدمات عبر الإنترنت. تتضمن عمليات الشراء والبيع عبر الإنترنت والدفع الإلكتروني والمنصات الرقمية حيث يمكن للشركات والمستهلكين القيام بأنشطة الشراء والبيع، وغالبًا ما يتم تسهيلها من خلال مواقع الويب وتطبيقات الهواتف المحمولة.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>تركز خدمات تحسين محركات البحث (SEO) على تحسين مواقع الويب لزيادة رؤيتها على محركات البحث. يتضمن ذلك أبحاث الكلمات الرئيسية، وتحسين الصفحة والتحسين خارج الصفحة، وإنشاء المحتوى، واعتماد استراتيجيات أخرى لتعزيز تصنيفات البحث العضوي وجذب حركة مستهدفة إلى الموقع الإلكتروني.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>خدمة تطوير الويب هي عملية بناء وتطوير مواقع الويب وتطبيقات الويب التي تعمل عبر الإنترنت. تهدف خدمتنا في تطوير الويب إلى إنشاء مواقع وتطبيقات ويب بوظائف ممتازة وأداء عالي وتجربة مستخدم فعّالة.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>خدمة صيانة التطبيقات النقالة هي عملية تصميم وتطوير التطبيقات التي تعمل على أجهزة الهاتف المحمول مثل الهواتف الذكية والأجهزة اللوحية. تهدف خدمة تطبيقات الهاتف المحمول إلى توفير تجربة مستخدم مريحة وسلسة ومتكاملة للمستخدمين على الأجهزة المحمولة.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>خدمة التسويق الإلكتروني هي استخدام وسائط رقمية ومنصات إلكترونية للترويج وتسويق المنتجات والخدمات. تهدف هذه الخدمة إلى زيادة الوعي ونشر العلامة التجارية الخاصة بمنتج معين، وزيادة المبيعات وعدد العملاء المحتملين.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>تطوير الأعمال يشمل إيجاد فرص نمو للشركة. يتضمن ذلك تحديد شراكات استراتيجية، توسيع الوجود في السوق، الحصول على عملاء جدد، وتطوير منتجات أو خدمات مبتكرة. الهدف هو تعزيز الإيرادات وحصة السوق وأداء الأعمال بشكل عام.</p>
                                    </div>
                                </div>
                                <!-- Choose Us Item End -->
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                ...
                                <div class="choose-us-item-02">
                                    ...
                                    <div class="choose-us-content">
                                        ...
                                        <p>
                                            خدمات التصميم تشمل مجموعة من المهن الإبداعية، بما في ذلك تصميم الجرافيك، تصميم الويب، وتصميم تجربة المستخدم (UX). يستخدم المصممون مهاراتهم الفنية والتقنية لإنشاء حلول بصرية جذابة ووظيفية، مثل الشعارات والمواقع وواجهات المستخدم، مصممة لتلبية احتياجات العملاء.
                                            </p>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget-about">
                                <a class="footer-logo" href="index.html"><img src="assets/images/black logo.jpg" alt="Logo"></a>
                                <p>نسرع في تحقيق الابتكار مع فرق تقنية من الطراز العالمي. سنقوم بمطابقتك مع فريق كامل من المواهب الحرة المذهلة البعيدة.</p>
                                <div class="footer-social">
                                    <ul class="social">
                                        <li><a href="https://www.facebook.com/inomtechs2022"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="https://www.linkedin.com/company/inomtech/"><i class="fab fa-linkedin-in"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Footer Widget End -->
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="footer-widget">
                                <h4 class="footer-widget-title">لينكات مفيدة</h4>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <!-- Footer Widget Start -->
                            <div class="footer-widget">
                                <h4 class="footer-widget-title">منتجاتنا</h4>
                                ...
                                <div class="widget-info">
                                    <ul>
                                        <li>
                                            ...
                                            <div class="info-text">
                                                <h3 class="number" style="color:white; ">+20 155 678 3315</h3>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info-icon">
                                            ...
                                            <div class="info-text">
                                                <span><a href="#">Info@inom-techs.com</a></span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="info-icon">
                                            ...
                                            <div class="info-text">
                                                <span>الاقبال  لوران الاسكندرية مصر</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright-text text-center">
                                    <p>© Copyrights 2023 InomTechs All rights reserved. </p>
                                </div>
...
<!-- Mirrored from thepixelcurve.com/html/techwix/techwix/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Oct 2023 15:06:51 GMT -->
</html>